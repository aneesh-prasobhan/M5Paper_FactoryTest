...
void Frame_BlukiiHub::InitSwitch(EPDGUI_Switch* sw, String title, String subtitle, const uint8_t *img1, const uint8_t *img2)
{
...
void key_home_air_adjust_cb1(epdgui_args_vector_t &args)
{
...
void key_home_air_state0_cb1(epdgui_args_vector_t &args)
{
...
void key_home_air_state1_cb1(epdgui_args_vector_t &args)
{
    EPDGUI_Button *b1 = ((EPDGUI_Button*)(args[0]));
    EPDGUI_Button *b2 = ((EPDGUI_Button*)(args[1]));
    b1->SetEnable(true);
...
Frame_BlukiiHub::Frame_BlukiiHub(void)
{
    ...
    _key_air_1_plus->Bind(EPDGUI_Button::EVENT_RELEASED, key_home_air_adjust_cb1);
    ...
    _key_air_1_minus->Bind(EPDGUI_Button::EVENT_RELEASED, key_home_air_adjust_cb1);
    ...
    _key_air_2_plus->Bind(EPDGUI_Button::EVENT_RELEASED, key_home_air_adjust_cb1);
    ...
    _key_air_2_minus->Bind(EPDGUI_Button::EVENT_RELEASED, key_home_air_adjust_cb1);
